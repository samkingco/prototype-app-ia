...
export interface ListItemProps {
  ...
  renderComponentRight?: React.ReactNode;
  to?: string;
  linkType?: ListItemLinkType;
...
export function ListItem(props: ListItemProps) {
  ...
  const hasRightComponent = Boolean(props.renderComponentRight);
  ...
  const content = (
    <>
      ...
      {props.renderComponentRight ? props.renderComponentRight : null}
      {hasRightIcon && (
