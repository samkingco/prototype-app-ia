  ...
  return (
    <Card>
      <List gap={1}>
        ...
        <Text>We’ve returned your prescription to the NHS system.</Text>
        <Text>
          This means you can collect your medication from your local pharmacy.
          Just show them the following prescription serial number.
        </Text>
      </List>
      <Divider />
