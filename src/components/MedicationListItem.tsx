...
interface StatusTagProps {
  ...
  showUnknownSupplyQuestion?: boolean;
}
...
function StatusTag(props: StatusTagProps) {
  const {
    ...
    hasLowSupply,
    isOutOfStock,
    showUnknownSupplyQuestion,
  } = props;

  if (!hasRequestInProgress && !amountRemainingInDays) {
    if (showUnknownSupplyQuestion) {
      return <Tag>When does this run out?</Tag>;
    }
    return <Tag>Your supply is unknown</Tag>;
  }
...
export function MedicationListItem({
  showIcon = true,
  showUnknownSupplyQuestion = false,
  ...props
          ...
          <>
            ...
            <div>
              <StatusTag
                ...
                showUnknownSupplyQuestion={showUnknownSupplyQuestion}
              />
            </div>
          </>
        ) : null
